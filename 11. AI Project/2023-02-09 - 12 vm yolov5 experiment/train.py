...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/data_birds_x.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='2023-02-09-5th', help='save to project/name')
