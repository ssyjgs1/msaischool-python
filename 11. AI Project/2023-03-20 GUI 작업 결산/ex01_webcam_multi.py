            ...
            for frame_idx, batch in enumerate(dataset):
                if self.isCamOn:  
                    ...
                    for i, det in enumerate(p):  # detections per image
                        print("Process detections 중 1 Webcam Flag : ", self.isCamOn)
                        if self.isCamOn == False:
                            print("Process detections 중 Webcam is off(False)")
                            return 
                        else:
                            print("Process detections 중 Webcam is on(True)")
                            pass
                        '''
                        ...
                        if det is not None and len(det):
                            ...
                            for numb_track, name_track, tracked_time in individual_List:
                                ...
                                if numb_track in target_List:
                                    ...
                                    print('No. of Objects: ', numb_track)
                                #elif frame_List
                            
                            print("if det is not None and len(det) 구간 중 : ", individual_List)
                        ...
                        # print(img) # NumPy 배열로 생겨먹은 이미지 쭉 출력해줌
...
if __name__ == '__main__':
    ...
    myWindow.show()
    th1 = Process(target=Ui_MainWindow)
    th2 = Process(target=email_form)
