...
cfg.model.roi_head.bbox_head.num_classes = 13 # 모델에 들어가는 클래스 갯수 수정. resnet 계열이 대체로 roi_head 부분에서 설정함
...
checkpoint_file = './work_dirs/0130/latest.pth' # 평가에 사용할(=학습에 사용했던) 모델을 불러오자
...
# img = './dataset/test/511_jpg.rf.b70e77817865b09f7004a1a82401c850.jpg' # 보려는 이미지 아무거나 1장 경로 지정
...
for img_info in image_info['images'] : # json 데이터 상위에 위치
    ...
    img_path = os.path.join('./dataset/test/', file_name) # 입력한 경로 안의 파일을 보자
